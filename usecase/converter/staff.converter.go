...
type StaffConverter interface {
	...
	ToDBColumnNamesFromRawArgs(map[string]interface{}) ([]string, error)
}
...
func (c staffConverterImpl) ToDBColumnNamesFromRawArgs(rawArgs map[string]interface{}) ([]string, error) {
